...
export class LessonsService {
  ...
  async updateLesson(lessonId: string, lessonUpdates: Partial<Lesson>): Promise<Lesson> {
    const lesson$ = this.http.put<Lesson>(`${this.env.apiRoot}/lessons/${lessonId}`, lessonUpdates)
